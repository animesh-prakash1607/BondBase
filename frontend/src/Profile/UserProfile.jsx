 ...
 const getRelativeTime = (date) => {
   ...
   {user && !edit  ? (
     <div className="w-full  bg-[#10121b66] p-[10px] sm:p-6 rounded-2xl shadow-lg space-y-6">
       ...
       <div className="flex justify-between items-center border-b-[1px] pb-3 sm:pb-6 border-[#71779040]">
         ...
         />
         <div>
           <h2 className=" text-[24px] sm:text-3xl font-semibold text-white">{profile.firstName} {profile.lastName}</h2>
           <p className='text-[14px] sm:text-xl text-gray-400'>{profile.title}</p>
       ...
       <div className='bg-[#10121b66] p-2 rounded-md mb-1'>
      <div className='flex flex-col gap-1 sm:gap-0 sm:flex-row justify-between p-2 rounded-md'>
         <div className='flex items-center gap-1'>
           ...
           <div className='text-gray-200 text-[16px]'>{profile.email}</div>
         </div>
         <div className='flex items-center gap-1'>
       ...
       <div className="text-gray-200 mb-4  p-3 rounded-md">
        ...
        <div className='w-full bg-[#10121b66] text-white p-6 rounded-xl shadow space-y-1 mt-1 sm:mt-4 mx-auto'>
   ...
   <div className='flex justify-between items-center'>
     ...
     {(profile?.privacy ==='public' || profile?.followers?.includes(visitorId)) ? (
      <div className='mt-10 mb-10 sm:mt-20 px-6'>
